<?php
// Arquivo de criação da integração via API redirecionando para o site do mercado pago
        ...
        if (isset($obj->id)) {
            if ($obj->id != NULL) {
                ...
                if (isset($card)) {
                    ...
                    echo "<button><a href='{$link_externo}' target='_blank' >Link externo</a></button>";
